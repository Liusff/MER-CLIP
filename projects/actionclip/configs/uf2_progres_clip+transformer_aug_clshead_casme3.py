...
model = dict(
    ...
    to_float32=True,
    labels_or_label_file='data/casme3/AUlabel_map_1.txt',
...
dataset_type = 'CASME3RawFrameWithAUDataset'

data_root = '/path/to/your/datasets/CASME3/partA/casme3a_static_aligned_croped'
data_root_val = '/path/to/your/datasets/CASME3/partA/casme3a_static_aligned_croped'
data_root_test = '/path/to/your/datasets/CASME3/partA/casme3a_static_aligned_croped'
ann_file_train = 'data/casme3/casme3_7class_emolabel_list.txt'
ann_file_val = 'data/casme3/casme3_7class_emolabel_list.txt'
ann_file_test = 'data/casme3/casme3_7class_emolabel_list.txt'
au_ann_file_train = 'data/casme3/casme3_AU_list.txt'
au_ann_file_val = 'data/casme3/casme3_AU_list.txt'
au_ann_file_test = 'data/casme3/casme3_AU_list.txt'
...
label_map = {"0": "anger", "1": "disgust", "2": "fear", "3": "happy", "4": "others", "5": "sad", "6": "surprise"}
