...
ann_file_train = 'data/casme2/casme2_3class_emolabel_list.txt'
ann_file_val = 'data/casme2/casme2_3class_emolabel_list.txt'
ann_file_test = 'data/casme2/casme2_3class_emolabel_list.txt'
au_ann_file_train = 'data/casme2/casme2_3class_AU_list.txt'
au_ann_file_val = 'data/casme2/casme2_3class_AU_list.txt'
au_ann_file_test = 'data/casme2/casme2_3class_AU_list.txt'
...
label_map = {"0": "negative", "1": "positive", "2": "surprise"}
