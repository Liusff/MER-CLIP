...
ann_file_train = 'data/samm/samm_5class_emolabel_list.txt'
ann_file_val = 'data/samm/samm_5class_emolabel_list.txt'
ann_file_test = 'data/samm/samm_5class_emolabel_list.txt'
