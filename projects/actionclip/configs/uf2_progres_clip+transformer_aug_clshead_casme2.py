...
model = dict(
    ...
    vision_encoder_config=dict(
        ...
        init_cfg=dict(
            checkpoint=
            'work_dirs/uf2_clip_dfme/epoch_50.pth',
    ...
    to_float32=True,
    labels_or_label_file='data/casme2/AUlabel_map.txt',
...
dataset_type = 'CASME2RawFrameWithAUDataset'

data_root = '/path/to/your/datasets/CASME2/CASMEII_16KEY_ORI_CLASSES20220221_addSub'
data_root_val = '/path/to/your/datasets/CASME2/CASMEII_16KEY_ORI_CLASSES20220221_addSub'
data_root_test = '/path/to/your/datasets/CASME2/CASMEII_16KEY_ORI_CLASSES20220221_addSub'
ann_file_train = 'data/casme2/casme2_5class_emolabel_list.txt'
ann_file_val = 'data/casme2/casme2_5class_emolabel_list.txt'
ann_file_test = 'data/casme2/casme2_5class_emolabel_list.txt'
au_ann_file_train = 'data/casme2/casme2_5class_AU_list.txt'
au_ann_file_val = 'data/casme2/casme2_5class_AU_list.txt'
au_ann_file_test = 'data/casme2/casme2_5class_AU_list.txt'
...
'''
train_pipeline = [
    dict(type='RawFrame_noSample_Decode'),
    #dict(type='Resize', scale=(224, 224), keep_ratio=False),
...
train_dataloader = dict(
    ...
    sampler=dict(type='ImbalancedSampler', shuffle=False),
    dataset=dict(
        type=dataset_type,
...
label_map = {"0": "disgust", "1": "happiness", "2": "others", "3": "repression", "4": "surprise"}
