...
model = dict(
    ...
    text_encoder_config=dict(
        ...
        output_dim=clip_output_dim,
        context_length=32),
    text_encoder_pretrain="projects/actionclip/pretrained/ViCLIP-B_InternVid-200M.pth",
    freeze_text=True,
    ...
    final_weight=1.0,
    total_epochs=55,
    visual_batch_video=False)

dataset_type = 'CASME2RawFrameWithAUDataset'

data_root = '/path/to/your/datasets/CASME2/Cropped2_all_regroup_by_original_classes'
data_root_val = '/path/to/your/datasets/CASME2/Cropped2_all_regroup_by_original_classes'
data_root_test = '/path/to/your/datasets/CASME2/Cropped2_all_regroup_by_original_classes'
ann_file_train = 'data/casme2/casme2_5class_emolabel_list_ori.txt'
ann_file_val = 'data/casme2/casme2_5class_emolabel_list_ori.txt'
ann_file_test = 'data/casme2/casme2_5class_emolabel_list_ori.txt'
