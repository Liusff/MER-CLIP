...
model = dict(
    ...
    templates_or_template_file="data/templates_1.txt",
...
data_root = '/path/to/your/datasets/SAMM/SAMM_16KEY_ORI_RGB_CLASS20210117_1_addSub/'
data_root_val = '/path/to/your/datasets/SAMM/SAMM_16KEY_ORI_RGB_CLASS20210117_1_addSub/'
data_root_test = '/path/to/your/datasets/SAMM/SAMM_16KEY_ORI_RGB_CLASS20210117_1_addSub/'
ann_file_train = 'data/samm/samm_3class_emolabel_list.txt'
ann_file_val = 'data/samm/samm_3class_emolabel_list.txt'
ann_file_test = 'data/samm/samm_3class_emolabel_list.txt'
au_ann_file_train = 'data/samm/samm_3class_AU_list.txt'
au_ann_file_val = 'data/samm/samm_3class_AU_list.txt'
au_ann_file_test = 'data/samm/samm_3class_AU_list.txt'
...
optim_wrapper = dict(
    optimizer=dict(
        type='AdamW', lr=7e-5, betas=(0.9, 0.999), weight_decay=0.05),
    paramwise_cfg=dict(norm_decay_mult=0.0, bias_decay_mult=0.0),
    clip_grad=dict(max_norm=20, norm_type=2))
