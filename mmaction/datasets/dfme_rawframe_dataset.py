...
class DFMERawFrameWithAUDataset(BaseActionDataset):
    ...
    def load_data_list(self) -> List[dict]:
        ...
        for i in range(len(emo_fin)):
            ...
            data_list.append(dict(filename=filename, label=label, au_label=au_label))
            self.labels.append(label)
        return data_list
    '''
    def get_labels(self) -> List[int]:
        labels = [x['label'] for x in self.data_list]
    '''
